...
| [PROYECTO — Hybrid Heaven: Recompiled (contexto maestro)](../PROYECTO.md) | **Fuente de verdad del contexto y el estado.** Mantenerlo corto (≈1-2 pantallas). | 121 | 2026-09-21 |
...
| [TODO — Hybrid Heaven: Recompiled](../TODO.md) | **Única fuente de verdad de tareas.** `[ ]` pendiente · `[•]` en curso · `[x]` hecho. | 73 | 2026-09-21 |
...
| [Hybrid Heaven Recomp — Build para Windows](BUILDING_windows.md) | Guía para compilar el port en Windows (MSVC / Visual Studio). La recompilación de funciones se hace | 307 | 2026-09-21 |
...
| [2026-09-21 — Audio: petardeo ligero — causa probable y plan (con la referencia)](../notes/2026-09-21-audio-petardeo-ref-y-plan.md) | Nota de tarea para sesión fresca. El resto del port está **validado en Windows** y **publicado** | 95 | 2026-09-21 |

...
| [TODO — Hybrid Heaven: Recompiled](../TODO.md) | **Única fuente de verdad de tareas.** `[ ]` pendiente · `[•]` en curso · `[x]` hecho. | 72 | 2026-09-21 |
...
| [Arquitectura — Hybrid Heaven: Recompiled](architecture.md) | Documento vivo. Modelo técnico canónico del port. Las decisiones se registran en `docs/adr/`. | 254 | 2026-09-21 |
...
| [2026-09-21 — Audio: petardeo ligero — causa probable y plan (con la referencia)](../notes/2026-09-21-audio-petardeo-ref-y-plan.md) | Nota de tarea para sesión fresca. El resto del port está **validado en Windows** y **publicado** | 74 | 2026-09-21 |

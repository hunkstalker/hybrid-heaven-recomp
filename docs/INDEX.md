...
| [TODO — Hybrid Heaven: Recompiled](../TODO.md) | **Única fuente de verdad de tareas.** `[ ]` pendiente · `[•]` en curso · `[x]` hecho. | 69 | 2026-09-18 |
...
| [2026-09-18 (ter) — Diferencial port↔emulador por VI en el CaC: paridad cuando el port no congela](../notes/2026-09-18-diferencial-port-emu-vi-cac-paridad.md) | Ejecuta el plan de `RETOMAR.md` (diferencial en el MISMO VI alrededor del envenenamiento) con el | 209 | 2026-09-18 |

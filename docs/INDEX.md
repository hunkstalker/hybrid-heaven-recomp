...
| [TODO — Hybrid Heaven: Recompiled](../TODO.md) | **Única fuente de verdad de tareas.** `[ ]` pendiente · `[•]` en curso · `[x]` hecho. | 197 | 2026-09-24 |
...
| [Hybrid Heaven Recomp — Build para Windows](BUILDING_windows.md) | Guía para compilar el port en Windows (MSVC / Visual Studio). La recompilación de funciones se hace | 396 | 2026-09-24 |
...
| [Menú inicial del port (`hh_menu`)](menu.md) | Documento vivo. **Diseño acordado (2026-09-23)** e implementación del menú inicial propio del port. | 168 | 2026-09-24 |
...
| [A2 — Paso 5: navegación propia y control total del menú de título](../notes/2026-09-24-a2-navegacion-propia-y-control-total.md) | Sesión 2026-09-24 (continuación). Implementa el **paso 5** del orden acordado en `RETOMAR.md`: | 76 | 2026-09-24 |
...
| [A2 — overlay por render hook de RT64: infra + atlas (Fase A)](../notes/2026-09-23-a2-render-hook-y-atlas.md) | Sesión 2026-09-23 (2.ª del día). Implementa la vía decidida en | 166 | 2026-09-23 |

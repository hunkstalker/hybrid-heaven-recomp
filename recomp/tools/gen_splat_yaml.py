...
options:
  ...
  asm_path: build/recomp/asm
  data_path: build/recomp/asm/data
  src_path: build/recomp/src_unused
  build_path: build/recomp/build-elf
  ...
  ld_script_path: build/recomp/hybrid-heaven.us.ld
  symbol_addrs_path:
    - recomp/symbol_addrs.txt
    - recomp/auto_funcs.txt
  undefined_funcs_auto_path: build/recomp/undefined_funcs_auto.txt
  undefined_syms_auto_path: build/recomp/undefined_syms_auto.txt

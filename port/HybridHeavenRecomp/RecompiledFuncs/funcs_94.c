...
RECOMP_FUNC void M10_FUN_8021dc6c(uint8_t* rdram, recomp_context* ctx) {
    uint64_t hi = 0, lo = 0, result = 0;
    int c1cs = 0;
    // 0x8021DC6C: addiu       $sp, $sp, -0x48
    ctx->r29 = ADD32(ctx->r29, -0X48);
    // 0x8021DC70: lui         $a2, 0x801C
    ctx->r6 = S32(0X801C << 16);
    // 0x8021DC74: addiu       $a2, $a2, -0x4410
    ctx->r6 = ADD32(ctx->r6, -0X4410);
    // 0x8021DC78: lw          $v0, 0xDC($a2)
    ctx->r2 = MEM_W(ctx->r6, 0XDC);
    // 0x8021DC7C: sw          $ra, 0x24($sp)
    MEM_W(0X24, ctx->r29) = ctx->r31;
    // 0x8021DC80: sw          $s0, 0x20($sp)
    MEM_W(0X20, ctx->r29) = ctx->r16;
    // 0x8021DC84: sw          $a1, 0x4C($sp)
    MEM_W(0X4C, ctx->r29) = ctx->r5;
    // 0x8021DC88: lw          $t6, 0x5C($a0)
    ctx->r14 = MEM_W(ctx->r4, 0X5C);
    // 0x8021DC8C: lw          $t0, 0x68($a0)
    ctx->r8 = MEM_W(ctx->r4, 0X68);
    // 0x8021DC90: or          $s0, $a0, $zero
    ctx->r16 = ctx->r4 | 0;
    // 0x8021DC94: bne         $a0, $v0, L_8021DCA8
    if (ctx->r4 != ctx->r2) {
        // 0x8021DC98: sw          $t6, 0x40($sp)
        MEM_W(0X40, ctx->r29) = ctx->r14;
            goto L_8021DCA8;
    }
    // 0x8021DC98: sw          $t6, 0x40($sp)
    MEM_W(0X40, ctx->r29) = ctx->r14;
    // 0x8021DC9C: lui         $v1, 0x801C
    ctx->r3 = S32(0X801C << 16);
    // 0x8021DCA0: b           L_8021DCB0
    // 0x8021DCA4: addiu       $v1, $v1, -0x3FC4
    ctx->r3 = ADD32(ctx->r3, -0X3FC4);
        goto L_8021DCB0;
    // 0x8021DCA4: addiu       $v1, $v1, -0x3FC4
    ctx->r3 = ADD32(ctx->r3, -0X3FC4);
L_8021DCA8:
    // 0x8021DCA8: lui         $v1, 0x801C
    ctx->r3 = S32(0X801C << 16);
    // 0x8021DCAC: addiu       $v1, $v1, -0x3C28
    ctx->r3 = ADD32(ctx->r3, -0X3C28);
L_8021DCB0:
    // 0x8021DCB0: beq         $s0, $v0, L_8021DCC4
    if (ctx->r16 == ctx->r2) {
        // 0x8021DCB4: lui         $a3, 0x801C
        ctx->r7 = S32(0X801C << 16);
            goto L_8021DCC4;
    }
    // 0x8021DCB4: lui         $a3, 0x801C
    ctx->r7 = S32(0X801C << 16);
    // 0x8021DCB8: lui         $a3, 0x801C
    ctx->r7 = S32(0X801C << 16);
    // 0x8021DCBC: b           L_8021DCC8
    // 0x8021DCC0: addiu       $a3, $a3, -0x3FC4
    ctx->r7 = ADD32(ctx->r7, -0X3FC4);
        goto L_8021DCC8;
    // 0x8021DCC0: addiu       $a3, $a3, -0x3FC4
    ctx->r7 = ADD32(ctx->r7, -0X3FC4);
L_8021DCC4:
    // 0x8021DCC4: addiu       $a3, $a3, -0x3C28
    ctx->r7 = ADD32(ctx->r7, -0X3C28);
L_8021DCC8:
    // 0x8021DCC8: sb          $zero, 0x392($v1)
    MEM_B(0X392, ctx->r3) = 0;
    // 0x8021DCCC: lbu         $v0, 0x1031($a2)
    ctx->r2 = MEM_BU(ctx->r6, 0X1031);
    // 0x8021DCD0: slti        $at, $v0, 0xA
    ctx->r1 = SIGNED(ctx->r2) < 0XA ? 1 : 0;
    // 0x8021DCD4: bne         $at, $zero, L_8021DCF4
    if (ctx->r1 != 0) {
        // 0x8021DCD8: addiu       $at, $zero, 0xF
        ctx->r1 = ADD32(0, 0XF);
            goto L_8021DCF4;
    }
    // 0x8021DCD8: addiu       $at, $zero, 0xF
    ctx->r1 = ADD32(0, 0XF);
    // 0x8021DCDC: beq         $v0, $at, L_8021DCF4
    if (ctx->r2 == ctx->r1) {
        // 0x8021DCE0: or          $a0, $s0, $zero
        ctx->r4 = ctx->r16 | 0;
            goto L_8021DCF4;
    }
    // 0x8021DCE0: or          $a0, $s0, $zero
    ctx->r4 = ctx->r16 | 0;
    // 0x8021DCE4: jal         0x8022310C
    // 0x8021DCE8: lw          $a1, 0x4C($sp)
    ...
    ctx->r5 = MEM_W(ctx->r29, 0X4C);
    after_0:
    // 0x8021DCEC: b           L_8021DE98
    // 0x8021DCF0: lw          $ra, 0x24($sp)
    ctx->r31 = MEM_W(ctx->r29, 0X24);
        goto L_8021DE98;
    // 0x8021DCF0: lw          $ra, 0x24($sp)
    ctx->r31 = MEM_W(ctx->r29, 0X24);
L_8021DCF4:
    // 0x8021DCF4: addiu       $at, $zero, 0xF
    ctx->r1 = ADD32(0, 0XF);
    // 0x8021DCF8: beq         $v0, $at, L_8021DE94
    if (ctx->r2 == ctx->r1) {
        // 0x8021DCFC: addiu       $a0, $sp, 0x2C
        ctx->r4 = ADD32(ctx->r29, 0X2C);
            goto L_8021DE94;
    }
    // 0x8021DCFC: addiu       $a0, $sp, 0x2C
    ctx->r4 = ADD32(ctx->r29, 0X2C);
    // 0x8021DD00: or          $a1, $s0, $zero
    ctx->r5 = ctx->r16 | 0;
    // 0x8021DD04: addiu       $a2, $zero, 0x21
    ctx->r6 = ADD32(0, 0X21);
    // 0x8021DD08: sw          $v1, 0x3C($sp)
    MEM_W(0X3C, ctx->r29) = ctx->r3;
    // 0x8021DD0C: sw          $a3, 0x38($sp)
    MEM_W(0X38, ctx->r29) = ctx->r7;
    // 0x8021DD10: jal         0x802256E4
    // 0x8021DD14: sw          $t0, 0x44($sp)
    ...
    MEM_W(0X44, ctx->r29) = ctx->r8;
    after_1:
    // 0x8021DD18: lhu         $t7, 0x32($sp)
    ctx->r15 = MEM_HU(ctx->r29, 0X32);
    // 0x8021DD1C: lw          $a0, 0x2C($sp)
    ctx->r4 = MEM_W(ctx->r29, 0X2C);
    // 0x8021DD20: lui         $at, 0x348
    ctx->r1 = S32(0X348 << 16);
    // 0x8021DD24: ori         $at, $at, 0x10
    ctx->r1 = ctx->r1 | 0X10;
    // 0x8021DD28: ori         $t8, $t7, 0x100
    ctx->r24 = ctx->r15 | 0X100;
    // 0x8021DD2C: lw          $v1, 0x3C($sp)
    ctx->r3 = MEM_W(ctx->r29, 0X3C);
    // 0x8021DD30: lw          $a3, 0x38($sp)
    ctx->r7 = MEM_W(ctx->r29, 0X38);
    // 0x8021DD34: lw          $t0, 0x44($sp)
    ctx->r8 = MEM_W(ctx->r29, 0X44);
    // 0x8021DD38: bne         $a0, $at, L_8021DD50
    if (ctx->r4 != ctx->r1) {
        // 0x8021DD3C: sh          $t8, 0x32($sp)
        MEM_H(0X32, ctx->r29) = ctx->r24;
            goto L_8021DD50;
    }
    // 0x8021DD3C: sh          $t8, 0x32($sp)
    MEM_H(0X32, ctx->r29) = ctx->r24;
    // 0x8021DD40: lui         $at, 0x4080
    ctx->r1 = S32(0X4080 << 16);
    // 0x8021DD44: mtc1        $at, $f4
    ctx->f4.u32l = ctx->r1;
    // 0x8021DD48: nop

    // 0x8021DD4C: swc1        $f4, 0x34($sp)
    MEM_W(0X34, ctx->r29) = ctx->f4.u32l;
L_8021DD50:
    // 0x8021DD50: lui         $at, 0x410
    ctx->r1 = S32(0X410 << 16);
    // 0x8021DD54: ori         $at, $at, 0x2B
    ctx->r1 = ctx->r1 | 0X2B;
    // 0x8021DD58: bne         $a0, $at, L_8021DD6C
    if (ctx->r4 != ctx->r1) {
        // 0x8021DD5C: lui         $at, 0x40A0
        ctx->r1 = S32(0X40A0 << 16);
            goto L_8021DD6C;
    }
    // 0x8021DD5C: lui         $at, 0x40A0
    ctx->r1 = S32(0X40A0 << 16);
    // 0x8021DD60: mtc1        $at, $f6
    ctx->f6.u32l = ctx->r1;
    // 0x8021DD64: nop

    // 0x8021DD68: swc1        $f6, 0x34($sp)
    MEM_W(0X34, ctx->r29) = ctx->f6.u32l;
L_8021DD6C:
    // 0x8021DD6C: lbu         $t9, 0x32($v1)
    ctx->r25 = MEM_BU(ctx->r3, 0X32);
    // 0x8021DD70: lbu         $t4, 0x38($v1)
    ctx->r12 = MEM_BU(ctx->r3, 0X38);
    // 0x8021DD74: lbu         $t2, 0x31($v1)
    ctx->r10 = MEM_BU(ctx->r3, 0X31);
    // 0x8021DD78: andi        $t1, $t9, 0xFF1F
    ctx->r9 = ctx->r25 & 0XFF1F;
    // 0x8021DD7C: sb          $t1, 0x32($v1)
    MEM_B(0X32, ctx->r3) = ctx->r9;
    // 0x8021DD80: andi        $t6, $t4, 0xFF7F
    ctx->r14 = ctx->r12 & 0XFF7F;
    // 0x8021DD84: lh          $t1, 0x2($v1)
    ctx->r9 = MEM_H(ctx->r3, 0X2);
    // 0x8021DD88: andi        $t8, $t6, 0xEF
    ctx->r24 = ctx->r14 & 0XEF;
    // 0x8021DD8C: sb          $t6, 0x38($v1)
    MEM_B(0X38, ctx->r3) = ctx->r14;
    // 0x8021DD90: sb          $t8, 0x38($v1)
    MEM_B(0X38, ctx->r3) = ctx->r24;
    // 0x8021DD94: andi        $t9, $t8, 0x9F
    ctx->r25 = ctx->r24 & 0X9F;
    // 0x8021DD98: andi        $t3, $t2, 0xFF9F
    ctx->r11 = ctx->r10 & 0XFF9F;
    // 0x8021DD9C: sb          $t3, 0x31($v1)
    MEM_B(0X31, ctx->r3) = ctx->r11;
    // 0x8021DDA0: blez        $t1, L_8021DDB8
    if (SIGNED(ctx->r9) <= 0) {
        // 0x8021DDA4: sb          $t9, 0x38($v1)
        MEM_B(0X38, ctx->r3) = ctx->r25;
            goto L_8021DDB8;
    }
    // 0x8021DDA4: sb          $t9, 0x38($v1)
    MEM_B(0X38, ctx->r3) = ctx->r25;
    // 0x8021DDA8: lw          $t2, 0x30($v1)
    ctx->r10 = MEM_W(ctx->r3, 0X30);
    // 0x8021DDAC: sll         $t3, $t2, 1
    ctx->r11 = S32(ctx->r10 << 1);
    // 0x8021DDB0: srl         $t4, $t3, 30
    ctx->r12 = S32(U32(ctx->r11) >> 30);
    // 0x8021DDB4: beq         $t4, $zero, L_8021DDCC
    if (ctx->r12 == 0) {
        // 0x8021DDB8: or          $a0, $s0, $zero
        ctx->r4 = ctx->r16 | 0;
            goto L_8021DDCC;
    }
L_8021DDB8:
    // 0x8021DDB8: or          $a0, $s0, $zero
    ctx->r4 = ctx->r16 | 0;
    // 0x8021DDBC: jal         0x802233B0
    // 0x8021DDC0: lw          $a1, 0x4C($sp)
    ctx->r5 = MEM_W(ctx->r29, 0X4C);
    ...
    ctx->r5 = MEM_W(ctx->r29, 0X4C);
    after_2:
    // 0x8021DDC4: b           L_8021DE98
    // 0x8021DDC8: lw          $ra, 0x24($sp)
    ctx->r31 = MEM_W(ctx->r29, 0X24);
        goto L_8021DE98;
    // 0x8021DDC8: lw          $ra, 0x24($sp)
    ctx->r31 = MEM_W(ctx->r29, 0X24);
L_8021DDCC:
    // 0x8021DDCC: lhu         $t5, 0x30($v1)
    ctx->r13 = MEM_HU(ctx->r3, 0X30);
    // 0x8021DDD0: addiu       $at, $zero, 0x5
    ctx->r1 = ADD32(0, 0X5);
    // 0x8021DDD4: andi        $t6, $t5, 0x7
    ctx->r14 = ctx->r13 & 0X7;
    // 0x8021DDD8: bnel        $t6, $at, L_8021DDF4
    if (ctx->r14 != ctx->r1) {
        // 0x8021DDDC: lhu         $t7, 0x4($t0)
    ...
    ctx->r15 = MEM_HU(ctx->r8, 0X4);
    skip_0:
    // 0x8021DDE0: jal         0x8022397C
    // 0x8021DDE4: or          $a0, $s0, $zero
    ctx->r4 = ctx->r16 | 0;
    ...
    ctx->r4 = ctx->r16 | 0;
    after_3:
    // 0x8021DDE8: b           L_8021DE98
    // 0x8021DDEC: lw          $ra, 0x24($sp)
    ctx->r31 = MEM_W(ctx->r29, 0X24);
        goto L_8021DE98;
    // 0x8021DDEC: lw          $ra, 0x24($sp)
    ctx->r31 = MEM_W(ctx->r29, 0X24);
    // 0x8021DDF0: lhu         $t7, 0x4($t0)
    ctx->r15 = MEM_HU(ctx->r8, 0X4);
L_8021DDF4:
    // 0x8021DDF4: addiu       $t4, $sp, 0x2C
    ctx->r12 = ADD32(ctx->r29, 0X2C);
    // 0x8021DDF8: andi        $t8, $t7, 0x8000
    ctx->r24 = ctx->r15 & 0X8000;
    // 0x8021DDFC: beql        $t8, $zero, L_8021DE44
    if (ctx->r24 == 0) {
        // 0x8021DE00: lw          $t6, 0x0($t4)
    ...
    ctx->r14 = MEM_W(ctx->r12, 0X0);
    skip_1:
    // 0x8021DE04: lbu         $t9, 0x30($a3)
    ctx->r25 = MEM_BU(ctx->r7, 0X30);
    // 0x8021DE08: andi        $t1, $t9, 0x1
    ctx->r9 = ctx->r25 & 0X1;
    // 0x8021DE0C: bnel        $t1, $zero, L_8021DE44
    if (ctx->r9 != 0) {
        // 0x8021DE10: lw          $t6, 0x0($t4)
        ctx->r14 = MEM_W(ctx->r12, 0X0);
            goto L_8021DE44;
    }
    goto skip_2;
    ...
    ctx->r14 = MEM_W(ctx->r12, 0X0);
    skip_2:
    // 0x8021DE14: lh          $t2, 0x6($v1)
    ctx->r10 = MEM_H(ctx->r3, 0X6);
    // 0x8021DE18: slti        $at, $t2, 0x1F
    ctx->r1 = SIGNED(ctx->r10) < 0X1F ? 1 : 0;
    // 0x8021DE1C: bnel        $at, $zero, L_8021DE44
    if (ctx->r1 != 0) {
        // 0x8021DE20: lw          $t6, 0x0($t4)
        ctx->r14 = MEM_W(ctx->r12, 0X0);
            goto L_8021DE44;
    }
    goto skip_3;
    ...
    ctx->r14 = MEM_W(ctx->r12, 0X0);
    skip_3:
    // 0x8021DE24: lh          $t3, 0x2($a3)
    ctx->r11 = MEM_H(ctx->r7, 0X2);
    // 0x8021DE28: beql        $t3, $zero, L_8021DE44
    if (ctx->r11 == 0) {
        // 0x8021DE2C: lw          $t6, 0x0($t4)
        ctx->r14 = MEM_W(ctx->r12, 0X0);
            goto L_8021DE44;
    }
    goto skip_4;
    ...
    ctx->r14 = MEM_W(ctx->r12, 0X0);
    skip_4:
    // 0x8021DE30: jal         0x802237EC
    // 0x8021DE34: or          $a0, $s0, $zero
    ctx->r4 = ctx->r16 | 0;
    ...
    ctx->r4 = ctx->r16 | 0;
    after_4:
    // 0x8021DE38: b           L_8021DE98
    // 0x8021DE3C: lw          $ra, 0x24($sp)
    ctx->r31 = MEM_W(ctx->r29, 0X24);
        goto L_8021DE98;
    // 0x8021DE3C: lw          $ra, 0x24($sp)
    ctx->r31 = MEM_W(ctx->r29, 0X24);
    // 0x8021DE40: lw          $t6, 0x0($t4)
    ctx->r14 = MEM_W(ctx->r12, 0X0);
L_8021DE44:
    // 0x8021DE44: addiu       $t7, $zero, 0x3
    ctx->r15 = ADD32(0, 0X3);
    // 0x8021DE48: lw          $a0, 0x4C($sp)
    ctx->r4 = MEM_W(ctx->r29, 0X4C);
    // 0x8021DE4C: sw          $t6, 0x8($sp)
    MEM_W(0X8, ctx->r29) = ctx->r14;
    // 0x8021DE50: lw          $a3, 0x4($t4)
    ctx->r7 = MEM_W(ctx->r12, 0X4);
    // 0x8021DE54: lw          $a2, 0x8($sp)
    ctx->r6 = MEM_W(ctx->r29, 0X8);
    // 0x8021DE58: lw          $a1, 0x40($sp)
    ctx->r5 = MEM_W(ctx->r29, 0X40);
    // 0x8021DE5C: sw          $a3, 0xC($sp)
    MEM_W(0XC, ctx->r29) = ctx->r7;
    // 0x8021DE60: lw          $t6, 0x8($t4)
    ctx->r14 = MEM_W(ctx->r12, 0X8);
    // 0x8021DE64: sw          $v1, 0x3C($sp)
    MEM_W(0X3C, ctx->r29) = ctx->r3;
    // 0x8021DE68: sw          $t7, 0x14($sp)
    MEM_W(0X14, ctx->r29) = ctx->r15;
    // 0x8021DE6C: jal         0x80011140
    // 0x8021DE70: sw          $t6, 0x10($sp)
    ...
    MEM_W(0X10, ctx->r29) = ctx->r14;
    after_5:
    // 0x8021DE74: beq         $v0, $zero, L_8021DE94
    if (ctx->r2 == 0) {
        // 0x8021DE78: lw          $v1, 0x3C($sp)
        ctx->r3 = MEM_W(ctx->r29, 0X3C);
            goto L_8021DE94;
    }
    // 0x8021DE78: lw          $v1, 0x3C($sp)
    ctx->r3 = MEM_W(ctx->r29, 0X3C);
    // 0x8021DE7C: addiu       $t8, $zero, 0x5A
    ctx->r24 = ADD32(0, 0X5A);
    // 0x8021DE80: lui         $a1, 0x8022
    ctx->r5 = S32(0X8022 << 16);
    // 0x8021DE84: sh          $t8, 0x312($v1)
    MEM_H(0X312, ctx->r3) = ctx->r24;
    // 0x8021DE88: addiu       $a1, $a1, -0x2058
    ctx->r5 = ADD32(ctx->r5, -0X2058);
    // 0x8021DE8C: jal         0x800058DC
    // 0x8021DE90: or          $a0, $s0, $zero
    ctx->r4 = ctx->r16 | 0;
    ...
    after_6:
L_8021DE94:
    // 0x8021DE94: lw          $ra, 0x24($sp)
    ctx->r31 = MEM_W(ctx->r29, 0X24);
L_8021DE98:
    // 0x8021DE98: lw          $s0, 0x20($sp)
    ctx->r16 = MEM_W(ctx->r29, 0X20);
    // 0x8021DE9C: addiu       $sp, $sp, 0x48
    ctx->r29 = ADD32(ctx->r29, 0X48);
    // 0x8021DEA0: jr          $ra
    // 0x8021DEA4: nop
